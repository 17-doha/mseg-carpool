...
const RideRow: React.FC<RideRowProps> = ({
  ...
  const handleDeleteClick = () => {
    if (
      window.confirm(`Are you sure you want to delete the ride of ${name}?`)
    ) {
      onDelete(id);
    }
  };
        ...
        <td>
          {own ? (
            <>
              {isEditing ? (
                <button
                  className="button-class save-btn"
                ...
                <button
                  className="button-class edit-btn"
                  onClick={handleEditClick}
                >
              ...
              <button
                className="button-class delete-btn"
